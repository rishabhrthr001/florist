...
# =============================================
# Mangalam - Ultimate Deployment (v4)
# FIXES: Network Refused, Missing Perms, Build Args
# STRATEGY: Cloud Build with explicit IAM fix
# =============================================
...
echo "============================================"
echo "Deploying Mangalam (Cloud Build - Proper Fix)"
...
# Grant Storage Admin to Cloud Build Service Account (Fixes 'forbidden' source error)
...
echo ""
echo "[1/7] Ensuring Artifact Registry Repo..."
...
echo ""
echo "[2/7] Generating Backend Build Config..."
...
echo "[3/7] Building Backend (Cloud Side)..."
cd backend
...
echo ""
echo "[6/7] Generating Frontend Build Config..."
...
echo "[7/7] Building Frontend (Cloud Side)..."
cd frontend
gcloud builds submit --config ../cloudbuild-frontend.yaml .
cd ..

echo ""
echo "[8/7] Deploying Frontend..."
...
echo ""
echo "[9/7] Syncing Configuration..."
