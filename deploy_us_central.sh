...
# =============================================
# Mangalam - Cloud Shell Deployment (US Central)
# REGION: us-central1
# =============================================
...
echo "============================================"
echo "Deploying Mangalam (US Central)"
...
gcloud artifacts repositories create $REPO_NAME \
    ...
    --location=$REGION \
    --description="Mangalam Docker Repository (US)" \
    || echo "Repo likely already exists, continuing..."

# Define Image Paths - NOTE: us-central1 prefix
