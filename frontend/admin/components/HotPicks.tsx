...
const HotPicks = () => {
  ...
  const fetchHotPicks = async () => {
    try {
      ...
      toast.error("Failed to load hot picks");
    }
  };
  ...
  const saveHotPicks = async () => {
    try {
      ...
      await axios.put(`${API}/home-section/hot-picks`, {
        items: payload,
      });

      toast.success("Hot picks updated");
      fetchHotPicks();
    } catch {
      ...
      <div className="bg-white p-6 rounded-3xl border border-[#E5E5E5]">
        <div className="flex justify-between mb-6">
          <p className="text-sm text-gray-500">
            Select exactly 4 featured products for homepage.
          </p>

          <button
            onClick={saveHotPicks}
        ...
        {isPickerOpen && (
          ...
          >
            ...
            >
              ...
              <h2 className="font-serif text-2xl mb-6">Select Product</h2>
