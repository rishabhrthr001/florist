...
# =============================================
# Mangalam - Cloud Shell Deployment (v3)
# NOW USES ARTIFACT REGISTRY (Fixes gcr.io connection refused)
# =============================================
...
echo "============================================"
echo "Deploying Mangalam (Artifact Registry Method)"
...
echo ""
echo "[0/6] Ensuring Artifact Registry Repo..."
# Create repo if not exists
gcloud artifacts repositories create $REPO_NAME \
    --repository-format=docker \
    --location=$REGION \
    --description="Mangalam Docker Repository" \
    || echo "Repo likely already exists, continuing..."
